    ...
    return {
        ...
        initData:function(){
            if(localStorage.getItem("collection") !== null && localStorage.getItem('rank') !== null && localStorage.getItem('app_index') !== null){
                ...
                var c1 = new Category("百度IFE项目");
                var c2 = new Category("毕业论文");
                var c3 = new Category("社团活动");
                var c4 = new Category("学校作业");
                ...
                var t1 = new Task('TASK0001','2015-04-15','完成百度IFE任务，TASK0001。');
                t1.finished = true;
                var t2 = new Task('TASK0002','2015-04-30','完成百度IFE任务，TASK0002。');
                t2.finished = true;
                var t3 = new Task('TASK0003','2015-05-18','完成百度IFE任务，task0003。');
                c1.addTask(t1);
                c1.addTask(t2);
                c1.addTask(t3);
